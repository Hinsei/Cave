...
var unistUtilIs = Object.freeze({

});

var is$2 = ( unistUtilIs && undefined ) || unistUtilIs;
...
function visit(tree, test, visitor, reverse) {
  ...
  function one(node, index, parent) {
    ...
    if (!test || node.type === test || is$2(test, node, index, parent || null)) {
...
var xtend$1 = ( immutable && undefined ) || immutable;
...
function getNodeProps(node, key, opts, renderer, parent, index) {
  ...
  switch (node.type) {
    ...
    case 'image':
      ...
      break;
    case 'linkReference':
      assignDefined(props, xtend$1(ref, {
...
function TableCell(props) {
  ...
  return createElement(props.isHeader ? 'th' : 'td', style ? xtend$1({ style: style }, coreProps) : coreProps, props.children);
}
...
var unified$2 = ( unified$1 && undefined ) || unified$1;

var parse$1 = ( remarkParse && undefined ) || remarkParse;
...
var ReactMarkdown = function ReactMarkdown(props) {
  ...
  var renderers$$1 = xtend$1(renderers, props.renderers);

  var plugins = [parse$1].concat(props.plugins || []);
  var parser = plugins.reduce(applyParserPlugin, unified$2());
  ...
  createClass(Article, [{
    ...
    value: function render() {
      return react.createElement(
        'article',
        null,
        react.createElement(reactMarkdown, null)
      );
    }
  }]);
  return Article;
