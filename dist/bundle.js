...
var about = "<h1 id=\"hello-world\">Hello World</h1>\n<hr>\n<p>My name is Aiman, I used to be cook, now I am a programmer. This is where I share some of things\nthat I am currently working on. It&#39;s to both act as a storage for all my notes and\nI hope it can be a useful resource for others.</p>\n<hr>\n";
...
function Article(filename) {
  return react.createElement(
    'article',
    null,
    react.createElement('div', { className: 'container_md', dangerouslySetInnerHTML: rawMarkdown(filename) })
  );
}
